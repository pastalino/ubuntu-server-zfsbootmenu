...
locale="de_DE.UTF-8" #New install language setting.
timezone="Europe/Vienna" #New install timezone setting.
...
EFI_boot_size="550" #EFI boot loader partition size in mebibytes (MiB).
swap_size="9000" #Swap partition size in mebibytes (MiB). Size of swap will be larger than defined here with Raidz topologies.
